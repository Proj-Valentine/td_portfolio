...
//     // },
//   {
//     title: "Software Enigeneer (Back-End)",
//     company_name: "D1g1t",
//     icon: python,
//     iconBg: "#383E56",
...
const experiences = [
  ...
  points: [
    ...
    "Streamlined user authentication and role-based access with Spring Boot, enhancing data security and user privacy.",
    "Enabled efficient development with CI/CD on AWS Amplify and Docker, facilitating faster deployments and reducing integration issues by 30%."
  ],
},
{
  ...
  points: [
    ...
    "Implemented CI/CD pipelines with Jenkins and GitHub Actions, decreasing integration errors by 93% and enabling seamless asynchronous deployments on AWS.",
